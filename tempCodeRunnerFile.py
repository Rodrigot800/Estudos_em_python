rograma para manipular IPv4 em notação CIDR
# Exemplo de entrada: 192.168.1.10/24

def ip_para_binario(ip):
    """
    Converte um IP em decimal (ex: 192.168.1.1)
    para sua representação binária (ex: 11000000.10101000.00000001.00000001)
    """
...
def mascara_rede(prefixo):
    """
    Gera a máscara de rede a partir do prefixo CIDR.
    Exemplo: prefixo 24 -> 255.255.255.0
    """
